...
class Reservoir():
    def __init__(self, n_internal_units = 50, spectral_radius = 0.99, leak = None,
    ...
    def _initialize_internal_weights_Circ(self, n_internal_units, spectral_radius):
        ...
        for i in range(n_internal_units-1):
            internal_weights[i+1, i] = spectral_radius0
...
res = Reservoir(n_internal_units=50, spectral_radius=0.6, leak=0.6,
